...
if query or selected_index is not None:
    ...
    st.markdown(f"<div style='flex: 1; background-color: #f0f0f0; padding: 15px; border-radius: 10px;'><strong>Kvalitetstrin 1:</strong><br>{hoved_resultat['Kvalitetstrin 1 Krav'] or 'Ikke tilgængelig'}</div>", unsafe_allow_html=True)
    st.markdown(f"<div style='flex: 1; background-color: #f0f0f0; padding: 15px; border-radius: 10px;'><strong>Kvalitetstrin 2:</strong><br>{hoved_resultat['Kvalitetstrin 2 Krav'] or 'Ikke tilgængelig'}</div>", unsafe_allow_html=True)
    st.markdown(f"<div style='flex: 1; background-color: #f0f0f0; padding: 15px; border-radius: 10px;'><strong>Kvalitetstrin 3:</strong><br>{hoved_resultat['Kvalitetstrin 3 Krav'] or 'Ikke tilgængelig'}</div>", unsafe_allow_html=True)
    st.markdown(f"<div style='flex: 1; background-color: #f0f0f0; padding: 15px; border-radius: 10px;'><strong>Kvalitetstrin 4:</strong><br>{hoved_resultat['Kvalitetstrin 4 Krav'] or 'Ikke tilgængelig'}</div>", unsafe_allow_html=True)
